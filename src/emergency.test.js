...
const summary = { waterDays: 1, rows: [{ category: 'hygiene', quantity: 10 }, { category: 'light', quantity: 1 }], categoryScores: [{ key: 'water', score: 30 }, { key: 'food', score: 80 }, { key: 'hygiene', score: 20 }, { key: 'light', score: 90 }, { key: 'heat', score: 50 }, { key: 'comfort', score: 100 }] };
...
describe('emergency planning', () => {
  it('turns household stock and contact gaps into an action plan', () => {
    ...
    expect(plan.gaps).toContain('集合場所と171などの連絡ルールを家族で決める');
  });
